...
var TableCell = function (_React$PureComponent) {
    ...
    _createClass(TableCell, [{
        ...
        value: function render() {
            ...
            var style = tdProps.style || {};
            if (column.width) {
                style.flex = (isLast ? 1 : 0) + ' 1 ' + ((0, _isNumber2.default)(column.width) ? column.width + 'px' : column.width);
            } else {
                style.flex = 1;
            }
            style.height = height;
            ...
            return _react2.default.createElement(
                BodyCell,
                _extends({
                    className: (0, _classnames2.default)(className, 'td')
                }, tdProps),
                text
            );
        }
