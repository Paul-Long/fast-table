...
var BaseTable = function (_React$PureComponent) {
  ...
  function BaseTable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BaseTable.__proto__ || Object.getPrototypeOf(BaseTable)).call.apply(_ref, [this].concat(args))), _this), _this.handleRowHover = function (isHover, key) {
      ...
      var _this$context$table$p = _this.context.table.props,
        footer = _this$context$table$p.footer,
        footerHeight = _this$context$table$p.footerHeight;

      return footer ? _react2.default.createElement(
        'div',
        {style: {position: 'absolute', bottom: 0, left: 0, right: 0, height: footerHeight, color: 'inherit'}},
        footer(_this.props.dataSource)
      ) : null;
    }, _this.renderEmptyText = function () {
      var _this$context$table$p2 = _this.context.table.props,
        emptyText = _this$context$table$p2.emptyText,
        dataSource = _this$context$table$p2.dataSource,
        rowHeight = _this$context$table$p2.rowHeight;

      if (dataSource && dataSource.length > 0) {
        return null;
      }
      return typeof emptyText === 'function' ? _react2.default.createElement(
        'div',
        {style: {position: 'absolute', bottom: 0, height: rowHeight, textAlign: 'center', color: 'inherit'}},
        emptyText(_this.props.dataSource)
      ) : emptyText;
