...
var BaseTable = function (_React$PureComponent) {
    ...
    function BaseTable() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BaseTable.__proto__ || Object.getPrototypeOf(BaseTable)).call.apply(_ref, [this].concat(args))), _this), _this.renderRows = function (datas) {
            var rows = [];
