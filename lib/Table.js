...
var _initialiseProps = function _initialiseProps() {
  ...
  this.syncFixedTableRowHeight = function () {
    ...
    var columnRefs = _this2.columnRefs || {};
    var colWidthMap = {};
    Object.keys(columnRefs).forEach(function (key) {
      var node = columnRefs[key];
    ...
    if (_this2.props.showHeader && (0, _shallowequal2.default)(state.fixedColumnsHeadRowsHeight, fixedColumnsHeadRowsHeight) && (0, _shallowequal2.default)(state.colWidthMap, colWidthMap)) {
      return;
    }
  ...
  this.saveColumnRef = function (dataIndex) {
    return function (node) {
      _this2.columnRefs = _this2.columnRefs || {};
      _this2.columnRefs[dataIndex] = node;
    };
  };
