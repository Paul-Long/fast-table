...
var Table = function (_React$PureComponent) {
  ...
  function Table(props) {
    ...
    _this.showCount = props.defaultShowCount || 30;
    ...
    }, _this.resetBodyHeight(props.dataSource || [])));
    _this.debouncedWindowResize = (0, _Utils.debounce)(_this.resetData, 150);
    return _this;
  }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.resetData = function () {
    var dataSource = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this2.props.dataSource;

    var _resetBodyHeight = _this2.resetBodyHeight(dataSource),
  ...
  this.resetBodyHeight = function (dataSource) {
  ...
  this.resetRenderInterval = function (scrollTop, clientHeight, scrollHeight, fixedColumnsBodyRowsHeight) {
    ...
    if (end < start || end - start < _this2.showCount) {
      end = start + _this2.showCount;
    }
    if (isNaN(end)) {
      console.log(start, end, _this2.showCount);
    }
    return {
      renderStart: start,
      renderEnd: end
